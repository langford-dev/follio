        ...
        <div className={editMode ? styles.previewMainEdit : styles.previewMain}>
...

            {
                showGithubStats && usernames.github ? <div className="mt-20">
                    ...
                    <Image width={1000} height={400} objectFit="contain" src={`https://github-readme-stats.vercel.app/api?username=${usernames.github}&count_private=true`} alt={`${usernames.github} GitHub stats`} />
