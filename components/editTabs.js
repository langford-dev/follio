...
const styles = {
    tab: `whitespace-nowrap mr-10 h-14 flex items-center pt-2 block opacity-50`,
    active: `whitespace-nowrap mr-10 h-14 flex items-center pt-2 block opacity-100 border-b-2 border-yellow-300`,
    main: `fixed top-12 left-0 bg-white border-b w-screen px-3 z-20 flex items-center overflow-x-scroll sm:hidden`,
