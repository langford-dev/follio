...
const ViewsTracker = () => {
    ...
    return <ul>
        ...
        <li onClick={() => setActive(7)} className={viewCount === 7 ? navStyles.activeNavLink : navStyles.navLink}>📅 Meeting schedule</li>
        <li onClick={() => setActive(3)} className={viewCount === 3 ? navStyles.activeNavLink : navStyles.navLink}>🎨 Styles &amp; colors</li>
        <li onClick={() => setActive(6)} className={viewCount === 6 ? navStyles.activeNavLink : navStyles.navLink}>🎁 Payments</li>
    </ul>
}
