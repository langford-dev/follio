const Button = ({ label, onPress }) => {
    return <div className="bg-brand text-light p-2 px-5 cursor-pointer hover:bg-light border w-max    whitespace-nowrap hover:text-dark rounded-md" onClick={onPress}>
        {label}
    </div>
    {/* <div
            onClick={onPress}
