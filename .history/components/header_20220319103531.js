...
const styles = {
    header: ``,
    headerWrapper: ``,
    button: `bg bg-blue-600 text-white h-10 px-5 flex items-center justify-center rounded-md cursor-pointer border-blue-600 border-1 hover:bg-transparent hover:text-blue-600`,
    nav: `flex`,
